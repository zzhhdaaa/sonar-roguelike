...
namespace Michsky.UI.Reach
{
    public class ControllerManager : MonoBehaviour
    {
        ...
        void CheckForEmptyObject()
        {
            ...
            if (gamepadHotkey.triggered) { SelectUIObject(panels[currentManagerIndex].panels[panels[currentManagerIndex].currentPanelIndex].firstSelected); }
        }
        ...
        {
            if (EventSystem.current.currentSelectedGameObject == null || EventSystem.current.currentSelectedGameObject.gameObject.activeInHierarchy == false)
            {
